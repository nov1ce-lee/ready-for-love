# Ready For Love - 亲密关系探索指引

> "在古老的智慧与现代的亲密之间，寻找灵魂与身体的共鸣"

这是一个融合了塔罗神秘学美学与性教育普及的互动式网页应用
不使用露骨的图像，而是通过抽象的艺术线条与符号，引导伴侣探索亲密关系的无限可能

## 🌟 项目愿景

这个项目试图打破传统的性教育刻板印象，将其转化为一场探索未知的仪式

每一次抽卡，都是一次对彼此身心的重新认识
...
1. **克隆仓库**
   ```bash
   git clone https://github.com/nov1ce-lee/ready-for-love.git
   cd readyForLove
   ```
